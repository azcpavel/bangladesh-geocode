...
class CreateDivisionDistrictsTable extends Migration
{
	...
	public function up()
	{
		...
		DB::table('division_districts')->insert([
			['id' =>1, 'division_id' =>1, 'name' =>'Dhaka', 'bn_name' =>'ঢাকা', 'lat' =>'23.7115253', 'lon' =>'90.4111451', 'website' =>'www.dhaka.gov.bd'],
			['id' =>2, 'division_id' =>1, 'name' =>'Faridpur', 'bn_name' =>'ফরিদপুর', 'lat' =>'23.6070822', 'lon' =>'89.8429406', 'website' =>'www.faridpur.gov.bd'],
			['id' =>3, 'division_id' =>1, 'name' =>'Gazipur', 'bn_name' =>'গাজীপুর', 'lat' =>'24.0022858', 'lon' =>'90.4264283', 'website' =>'www.gazipur.gov.bd'],
			['id' =>4, 'division_id' =>1, 'name' =>'Gopalganj', 'bn_name' =>'গোপালগঞ্জ', 'lat' =>'23.0050857', 'lon' =>'89.8266059', 'website' =>'www.gopalganj.gov.bd'],
			['id' =>5, 'division_id' =>8, 'name' =>'Jamalpur', 'bn_name' =>'জামালপুর', 'lat' =>'24.937533', 'lon' =>'89.937775', 'website' =>'www.jamalpur.gov.bd'],
			['id' =>6, 'division_id' =>1, 'name' =>'Kishoreganj', 'bn_name' =>'কিশোরগঞ্জ', 'lat' =>'24.444937', 'lon' =>'90.776575', 'website' =>'www.kishoreganj.gov.bd'],
			['id' =>7, 'division_id' =>1, 'name' =>'Madaripur', 'bn_name' =>'মাদারীপুর', 'lat' =>'23.164102', 'lon' =>'90.1896805', 'website' =>'www.madaripur.gov.bd'],
			['id' =>8, 'division_id' =>1, 'name' =>'Manikganj', 'bn_name' =>'মানিকগঞ্জ', 'lat' =>'0', 'lon' =>'0', 'website' =>'www.manikganj.gov.bd'],
			['id' =>9, 'division_id' =>1, 'name' =>'Munshiganj', 'bn_name' =>'মুন্সিগঞ্জ', 'lat' =>'0', 'lon' =>'0', 'website' =>'www.munshiganj.gov.bd'],
			['id' =>10, 'division_id' =>8, 'name' =>'Mymensingh', 'bn_name' =>'ময়মনসিংহ', 'lat' =>'0', 'lon' =>'0', 'website' =>'www.mymensingh.gov.bd'],
			['id' =>11, 'division_id' =>1, 'name' =>'Narayanganj', 'bn_name' =>'নারায়াণগঞ্জ', 'lat' =>'23.63366', 'lon' =>'90.496482', 'website' =>'www.narayanganj.gov.bd'],
			['id' =>12, 'division_id' =>1, 'name' =>'Narsingdi', 'bn_name' =>'নরসিংদী', 'lat' =>'23.932233', 'lon' =>'90.71541', 'website' =>'www.narsingdi.gov.bd'],
			['id' =>13, 'division_id' =>8, 'name' =>'Netrokona', 'bn_name' =>'নেত্রকোণা', 'lat' =>'24.870955', 'lon' =>'90.727887', 'website' =>'www.netrokona.gov.bd'],
			['id' =>14, 'division_id' =>1, 'name' =>'Rajbari', 'bn_name' =>'রাজবাড়ি', 'lat' =>'23.7574305', 'lon' =>'89.6444665', 'website' =>'www.rajbari.gov.bd'],
			['id' =>15, 'division_id' =>1, 'name' =>'Shariatpur', 'bn_name' =>'শরীয়তপুর', 'lat' =>'0', 'lon' =>'0', 'website' =>'www.shariatpur.gov.bd'],
			['id' =>16, 'division_id' =>8, 'name' =>'Sherpur', 'bn_name' =>'শেরপুর', 'lat' =>'25.0204933', 'lon' =>'90.0152966', 'website' =>'www.sherpur.gov.bd'],
			['id' =>17, 'division_id' =>1, 'name' =>'Tangail', 'bn_name' =>'টাঙ্গাইল', 'lat' =>'0', 'lon' =>'0', 'website' =>'www.tangail.gov.bd'],
			...
			['id' =>34, 'division_id' =>3, 'name' =>'Barguna', 'bn_name' =>'বরগুনা', 'lat' =>'0', 'lon' =>'0', 'website' =>'www.barguna.gov.bd'],
			['id' =>35, 'division_id' =>3, 'name' =>'Barishal', 'bn_name' =>'বরিশাল', 'lat' =>'0', 'lon' =>'0', 'website' =>'www.barisal.gov.bd'],
			['id' =>36, 'division_id' =>3, 'name' =>'Bhola', 'bn_name' =>'ভোলা', 'lat' =>'22.685923', 'lon' =>'90.648179', 'website' =>'www.bhola.gov.bd'],
			['id' =>37, 'division_id' =>3, 'name' =>'Jhalokati', 'bn_name' =>'ঝালকাঠি', 'lat' =>'0', 'lon' =>'0', 'website' =>'www.jhalakathi.gov.bd'],
			['id' =>38, 'division_id' =>3, 'name' =>'Patuakhali', 'bn_name' =>'পটুয়াখালী', 'lat' =>'22.3596316', 'lon' =>'90.3298712', 'website' =>'www.patuakhali.gov.bd'],
			['id' =>39, 'division_id' =>3, 'name' =>'Pirojpur', 'bn_name' =>'পিরোজপুর', 'lat' =>'0', 'lon' =>'0', 'website' =>'www.pirojpur.gov.bd'],
